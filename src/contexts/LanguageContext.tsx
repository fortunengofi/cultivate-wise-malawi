...
const dict = {
  en: {
    ...
    openFullPlan: "Open my full farm plan",
  ...
  ny: {
    ...
    navChats: "Macheza",
    navWeather: "Nyengo",
    navPlan: "Ndondomeko Yanga",
    navPrices: "Mitengo",
    navCalendar: "Kalendala",
    navIrrigation: "Kuthirira",
    todayAtGlance: "Zofunika Lero",
    openFullPlan: "Onani ndondomeko yanga yonse",
