    ...
    <footer className="mt-12 border-t border-border bg-card/50">
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          ...
          <div>
            <h4 className="font-bold text-sm text-foreground mb-2">App</h4>
            <ul className="space-y-1.5 text-xs">
              <li><Link to="/soil" className="text-muted-foreground hover:text-primary">Soil Analyzer</Link></li>
              <li><Link to="/market" className="text-muted-foreground hover:text-primary">Marketplace</Link></li>
              <li><Link to="/insights" className="text-muted-foreground hover:text-primary">Profit Insights</Link></li>
              <li><Link to="/about" className="text-muted-foreground hover:text-primary">About Developer</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="font-bold text-sm text-foreground mb-2">Developer</h4>
